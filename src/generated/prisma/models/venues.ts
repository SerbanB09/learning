...
export type venuesWhereInput = {
  ...
  id?: Prisma.StringFilter<"venues"> | string
  account_id?: Prisma.StringFilter<"venues"> | string
...
export type venuesScalarWhereWithAggregatesInput = {
  ...
  id?: Prisma.StringWithAggregatesFilter<"venues"> | string
  account_id?: Prisma.StringWithAggregatesFilter<"venues"> | string
...
export type venuesOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "account_id" | "name" | "address", ExtArgs["result"]["venues"]>
...
export interface venuesDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  /**
   * Find zero or more Venues that matches the filter.
   * @param {venuesFindRawArgs} args - Select which filters you would like to apply.
   * @example
   * const venues = await prisma.venues.findRaw({
   *   filter: { age: { $gt: 25 } }
   * })
   */
  findRaw(args?: Prisma.venuesFindRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>

  /**
   * Perform aggregation operations on a Venues.
   * @param {venuesAggregateRawArgs} args - Select which aggregations you would like to apply.
   * @example
   * const venues = await prisma.venues.aggregateRaw({
   *   pipeline: [
   ...
   * })
   */
  aggregateRaw(args?: Prisma.venuesAggregateRawArgs): Prisma.PrismaPromise<Prisma.JsonObject>
...
export interface venuesFieldRefs {
  ...
  readonly account_id: Prisma.FieldRef<"venues", 'String'>
 ...
 * venues findRaw
 */
export type venuesFindRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
 ...
 * venues aggregateRaw
 */
export type venuesAggregateRawArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
